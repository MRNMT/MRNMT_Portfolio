      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <nav style={{ marginBottom: '2rem' }}>
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap' }}>
            <li><Link to="/" style={{ color: 'var(--text-secondary, #8892b0)', textDecoration: 'none', transition: 'color 0.3s ease', fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent, #64ffda)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary, #8892b0)'}>Home</Link></li>
            <li><Link to="/about" style={{ color: 'var(--text-secondary, #8892b0)', textDecoration: 'none', transition: 'color 0.3s ease', fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent, #64ffda)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary, #8892b0)'}>About</Link></li>
            <li><Link to="/skills" style={{ color: 'var(--text-secondary, #8892b0)', textDecoration: 'none', transition: 'color 0.3s ease', fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent, #64ffda)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary, #8892b0)'}>Skills</Link></li>
            <li><Link to="/experience" style={{ color: 'var(--text-secondary, #8892b0)', textDecoration: 'none', transition: 'color 0.3s ease', fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent, #64ffda)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary, #8892b0)'}>Experience</Link></li>
            <li><Link to="/projects" style={{ color: 'var(--text-secondary, #8892b0)', textDecoration: 'none', transition: 'color 0.3s ease', fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent, #64ffda)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary, #8892b0)'}>Projects</Link></li>
            <li><Link to="/contact" style={{ color: 'var(--text-secondary, #8892b0)', textDecoration: 'none', transition: 'color 0.3s ease', fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent, #64ffda)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary, #8892b0)'}>Contact</Link></li>
          </ul>
        </nav>
